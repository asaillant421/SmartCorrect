...
enum Constants {
    ...
    static let defaultMainPrompt = "Improve and correct the following text. Focus on grammar, spelling, clarity, and style, while preserving the original tone and intent. Reply with only the corrected text."
